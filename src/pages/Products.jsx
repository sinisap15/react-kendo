        ...
        >
          ...
          <CardActions>
            <div className="footer-buttons-container">
              ...
              <span>
                <span
                  className="k-button k-button-md k-button-rectangle k-rounded-md k-button-flat k-button-flat-base"
              ...
              <span>
                <span
                  className="k-button k-edit-button k-button-md k-button-rectangle k-rounded-md k-button-flat k-button-flat-primary"
                  onClick={handleClick}
                >
                  <span
                    className={
                      isEditMode ? "k-icon k-i-check" : "k-icon k-i-edit"
                    }
                  ></span>
                  Edit
                </span>
