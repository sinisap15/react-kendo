...
export const DashboardGrid = () => {
  ...
  const PersonCell = (props) => {
    ...
    return (
      <td>
        <img
          src={require(`../../assets/people/${person}`)}
  ...
  const CustomBudgetCell = (props) => (
    <BudgetCell {...props} myProp={customData} />
  );
            ...
            <div>
              ...
              <div className="export-buttons-container">
                <button
                  ...
                  onClick={exportExcel}
                >
                  <span className="k-icon k-i-file-excel k-button-icon"></span>{" "}
                  Export to Excel
                </button>
                &nbsp;
                <button
                  ...
                  onClick={exportPDF}
                >
                  <span className="k-icon k-i-file-pdf k-button-icon"></span>{" "}
                  Export to PDF
                </button>
              </div>
            </div>
